...
//      checkVersion(SampleResultConverter.class, "571992");
//
//        // Not built until later, so need to use this method:
//        try {
//            checkVersion(
//                    Class.forName("org.apache.jmeter.protocol.http.util.HTTPResultConverter"),
//                    "514283");
//        } catch (ClassNotFoundException e) {
//            versionsOK = false;
...
//      checkVersion(TestElementConverter.class, "549987");
//      checkVersion(TestElementPropertyConverter.class, "549987");
//      checkVersion(ScriptWrapperConverter.class, "514283");
//      checkVersion(TestResultWrapperConverter.class, "514283");
//        checkVersion(SampleSaveConfigurationConverter.class,"549936");

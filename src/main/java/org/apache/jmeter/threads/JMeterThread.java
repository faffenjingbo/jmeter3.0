...
public class JMeterThread implements Runnable, Interruptible {
    ...
    public void run() {
        ...
        // Might be found by contoller.next()
            ...
            KafkaProducer.getInstance().send(KafkaProducer.KafkaTopics.YPT_KAFKA_JMETER_ERROR_TOPIC, "ERROR|" + JMeterUtils.getProperty("taskSignkey") + "|" + JMeterUtils.getProperty("taskParentSignkey") + "|" + e.getMessage() + "|" + e.getStackTrace()[0]);
        } catch (ThreadDeath e) {
